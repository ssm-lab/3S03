...
import bankServerExerciseWithCheckrep.Transaction;
import bankServerExerciseWithCheckrep.Transaction.TransactionType;



public final class BankServerWithACheckrep implements BankServerInterface {
...
//	@CheckRep
//	Tutorial Answers - comment out anything from the main files to fail the invariant
	public boolean checkHistoryMatchesCurrentBalance() {
	    int transBalance = 0;
	    ...
	    return transBalance == getNetValue();
	}
